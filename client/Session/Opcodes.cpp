...
OpcodeHandler OpcodeTable[MSG_COUNT] = 
{
    ...
    { "MSG_CREATE_ITEM",      &WorldSession::HandleCreateItemOpcode }, // SMSG
    { "MSG_INVENTORY_DATA",   &WorldSession::HandleInventoryDataOpcode }, // SMSG
    { "MSG_NPC_INTERACT",     &WorldSession::HandleNpcInteractOpcode }, // SMSG
    { "MSG_BUY_ITEM",         &WorldSession::HandleNULL }, // CMSG
    { "MSG_SELL_ITEM",        &WorldSession::HandleNULL }, // CMSG
    { "MSG_ACCEPT_QUEST",     &WorldSession::HandleNULL } // CMSG
};
